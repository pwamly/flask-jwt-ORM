   ...
   #  check if user exists
    ...
    if not order:
        try:
            ...
            pickupLocation = Destination.query.filter_by(id=pregion).first().name
            zname=Destination.query.filter_by(id=pregion).first().name
            zonalDestination = Zone.query.filter_by(id=Destination.query.filter_by(id=pregion).first().zoneid).first().name
